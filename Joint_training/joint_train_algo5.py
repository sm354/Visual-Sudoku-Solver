...
for epoch in range(num_epochs):
    ...
    for batch_id, (X_img, Y_img) in enumerate(train_data_loader):
        ...
        total_loss = l + args.lreg_factor * lreg
    ...
    lss_reg, lss_total = lss_reg/batch_id, lss_total/batch_id
    ...
    print("train loss (rnn, reg, total):(",lss, lss_reg, lss_total, ")| train acc sudoku:",100.*correct/total,"| train acc digit:",micro_score)
    ...
    print("valid loss (rnn, reg, total):(",lss, lss_reg, lss_total, ")| valid acc sudoku:",100.*correct/total,"| valid acc digit:",micro_score)
    print("-----------rnn output constraints satisfied----------")
